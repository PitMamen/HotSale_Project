...
public class Contants {
    ...
    public static class API{
        ...
        public static final String WARES_CAMPAIN_LIST=BASE_URL +"wares/campaign/list";   //商品列表接口



        public static final String CAMPAIGN_HOME=BASE_URL + "campaign/recommend";   //首页listview接口


        public static final String BANNER=BASE_URL +"banner/query";    //首页头部广告接口
